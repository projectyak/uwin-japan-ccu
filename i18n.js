...
equipBoundaryLabel: "UWin CCU System Boundary",
      ...
      a06Label: "NaOH Usage",
      monStatus: "Operating · Caution",
      legendCo2: "CO₂ Flow",
      legendCooling: "Cooling Circuit",
      legendStructure: "Structure",
      monAxes: "+X 12.4m · +Z 4.8m · 4 active sensors",
      svgCooler: "COOLER · C-100",
      svgAbsorber: "ABSORBER · T-200",
      svgFeedTank: "FEED TANK · V-250",
      svgReactor: "REACTOR · R-300",
      ...
      gateLead: "Please share a few details so our team can follow up with the right resources.",
      fTitle: "Title",
...
equipBoundaryLabel: "UWin CCU 系統計算邊界",
      ...
      legendCooling: "冷卻迴路",
      legendStructure: "結構",
      monAxes: "+X 12.4m · +Z 4.8m · 4 個感測器啟用",
      svgCooler: "冷卻器 · C-100",
      svgAbsorber: "吸收塔 · T-200",
      svgFeedTank: "進料槽 · V-250",
      svgReactor: "反應器 · R-300",
      ...
      gateLead: "進入網站前，請留下您的聯絡資訊，方便我們後續為您提供合適的資料。",
      fTitle: "職稱",
      fTitlePh: "永續發展經理",
    ...
    ja: {
      ...
      legendCooling: "冷却回路",
      legendStructure: "構造",
      monAxes: "+X 12.4m · +Z 4.8m · アクティブセンサー 4台",
      svgCooler: "冷却器 · C-100",
      svgAbsorber: "吸収塔 · T-200",
      svgFeedTank: "フィードタンク · V-250",
      svgReactor: "反応器 · R-300",
      ...
      gateLead: "サイトに入る前に、ご担当者様の情報をお聞かせください。",
      fTitle: "役職",
